  ...
  return (
    <div className={styles["details"]}>
      ...
      <div className={styles["details__row"]}>
        ...
        <label className={classNames(styles["input__outer"], styles["big"])}>
          <p>Estimated Value (This will help people only offer you Items of similar value)</p>
          <FormField
      ...
      <p>
        Please input accurate package dimensions and weight. If the carrier makes a shipping adjustment, your TradeShip wallet will be charged the additional fee.
        <br />
        <br />
        TradeShip will file a dispute for any carrier adjustments that may be wrong or accidental.
      </p>
      <br />
      <br />
      <div className={styles["details__title"]}>
